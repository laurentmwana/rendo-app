        ...
        <div class="max-w-7xl mx-auto flex h-14 items-center justify-between">
            <div class="mr-4 hidden md:flex">
                ...
                <nav class="flex items-center gap-4 text-sm lg:gap-6">
                    ...
                    <x-nav-link href="{{ route('&worker.index') }}" indexer="secretary/worker">
                        Travailleur
                    </x-nav-link>

                    <x-nav-link href="{{ route('&grade.index') }}" indexer="secretary/grade">
                        Grade
                    </x-nav-link>
                    ...
                    <div>
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link href="{{ route('&hourly.index') }}" indexer="secretary/hourly">
                                    Horaire
                                </x-dropdown-link>

                                <x-dropdown-link href="{{ route('&worker.index') }}" indexer="secretary/worker">
                                    Travailleur
                                </x-dropdown-link>

                                <x-dropdown-link href="{{ route('&grade.index') }}" indexer="secretary/grade">
                                    Grade
                                </x-dropdown-link>

                                <x-dropdown-link href="{{ route('&requester.index') }}" indexer="secretary/requester">
                                    Demandeur
                                </x-dropdown-link>
                                <x-dropdown-link href="{{ route('&appointment.index') }}"
                                    indexer="secretary/appointment">
                                    Réservation
                                </x-dropdown-link>
