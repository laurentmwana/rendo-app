<x-secretary-layout title="Gestion d'utilisateur">
        ...
        <table class="mb-4 w-full caption-bottom text-sm responsive-table">
            ...
            <tbody class="[&_tr:last-child]:border-0">
                ...
                <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                    ...
                    <td class="p-2 align-middle [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]">
                        <a href="{{ route('&requester.show', $user->requester) }}" class="hover:underline">
                            {{ $user->requester->name }} {{ $user->requester->firstname }}
                        </a>
                    </td>
